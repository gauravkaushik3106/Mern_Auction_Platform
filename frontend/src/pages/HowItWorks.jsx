  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <h1
          className={`text-teal-600 text-2xl font-bold mb-2 min-[480px]:text-3xl md:text-4xl xl:text-5xl 2xl:text-6xl`}
        >
          Discover How SuhBidz Operates
        </h1>
        <div className="flex flex-col gap-4 my-5">
          {steps.map((element, index) => {
            return (
              ...
              >
                <div className="bg-black text-white p-3 text-xl rounded-full w-fit group-hover:bg-teal-600 transition-all duration-300">
                  {element.icon}
                </div>
                <h3
                  className={`text-teal-600 text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}
                >
                  {element.title}
                </h3>
